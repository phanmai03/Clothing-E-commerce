      ...
      <div style={style} className="flex text-sm font-medium">
        ...
        <div className="w-[25%] p-2 whitespace-nowrap">
          <button
            ...
            className="bg-teal-500 shadow-lg hover:shadow-indigo-500/50 px-3 py-[2px cursor-pointer text-white rounded-sm text-sm]"
          >
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      <div className="w-full p-4 bg-[#7bbebb] rounded-md">
        <h2 className="text-xl font-medium pb-5 text-[#000000]">
          Withdrawal Request
        </h2>
        <div className="w-full">
          <div className="w-full overflow-x-auto">
            <div className="flex bg-[#38a59f] uppercase text-xs font-bold min-w-[340px] rounded-md">
