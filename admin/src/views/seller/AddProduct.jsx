...
const AddProduct = () => {
  ...
  const add = (e) => {
    ...
    formData.append("shopName", "Share And Care");
        ...
        <div>
          <form onSubmit={add}>
                ...
                >
                  <div className="w-full px-4 py-2 fixed">
                    <input
                      ...
                      className="px-3 py-1 w-full focus:border-gray-700 focus:border-2 placeholder:text-gray-700 outline-none bg-transparent border border-slate-700 rounded-md text-[#000000] overflow-hidden"
                      type="text"
                      placeholder="search"
                    />
                  </div>
            ...
            <div className="grid lg:grid-cols-4 grid-cols-1 md:grid-cols-3 sm:grid-cols-2 sm:gap-4 md:gap-4 gap-3 w-full text-[#000000] mb-4">
              ...
              <label
                className="flex justify-center items-center flex-col h-[180px] cursor-pointer border border-dashed hover:border-red-500 w-full text-[#000000]"
                htmlFor="image"
              >
                <span>
                  <IoMdImages />
