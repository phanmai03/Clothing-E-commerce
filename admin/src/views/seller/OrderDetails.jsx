    ...
    return (
        ...
        <div className='w-full p-4 bg-[#7bbebb] rounded-md'>
            <div className='flex justify-between items-center p-4'>
                ...
                <select onChange={status_update} value={status} name="" id="" className='px-4 py-2 focus:border-gray-700 focus:border-2 placeholder:text-gray-700 outline-none bg-[#38a59f] border border-slate-700 rounded-md text-[#000000]'>
        ...
        <div className='p-4'>
         ...
         {
            order?.products?.map((p,i) => <div key={i} className='mt-4 flex flex-col gap-4 bg-[#38a59f] rounded-md'>
