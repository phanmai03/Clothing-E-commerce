...
const SellerToCustomer = () => {
  ...
  return (
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full bg-[#7bbebb] px-4 py-4 rounded-md h-[calc(100vh-140px)]">
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto">
              <div className="flex text-xl justify-between items-center p-4 md:p-0 md:px-3 md:pb-3 text-gray-900">
                <h2>Customers</h2>
                <span
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
            ...
            <form onSubmit={send} className="flex gap-3">
              <input
                ...
                className="w-full flex justify-between px-2 border border-slate-700 items-center py-[5px] focus:border-gray-700 focus:border-2 placeholder:text-gray-700 rounded-md outline-none bg-transparent text-[#d0d2d6]"
                type="text"
