  ...
  return (
    <div className="px-2 md:px-7 py-5">
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-2 pb-4">
        <div className="bg-[#7bbebb] text-[#000000] rounded-md p-5">
            ...
            <form onSubmit={sendRequest}>
              <div className="flex gap-3 flex-wrap">
                <input
                  ...
                  min="0"
                  type="number"
                  className="px-3 py-2 md:w-[75%] focus:border-indigo-200 outline-none bg-[#7bbebb] border border-slate-700 rounded-md text-[#000000]"
                  name="amount"
                />
                <button
                  disabled={loader}
