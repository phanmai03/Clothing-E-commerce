    ...
    <div className="px-2 md:px-7 py-5">
      ...
      <div className="w-full flex flex-wrap mt-7">
        <div className="w-full lg:w-7/12 lg:pr-3">
          <div className="w-full bg-[#7bbebb] p-4 rounded-md">
            <Chart
        ...
        <div className="w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0">
          <div className="w-full bg-[#7bbebb] p-4 rounded-md text-[#000000]">
                ...
                {recentMessage.map((m, i) => (
                  <li className="mb-3 ml-6">
                    ...
                    <div className="p-3 bg-white rounded-lg border border-gray-300 shadow-sm">
                      ...
                      <div className="p-2 text-xs font-normal bg-gray-200 rounded-lg border border-white">
                        {m.message}
                      </div>
                    </div>
                  </li>
      ...
      <div className="w-full p-4 bg-[#7bbebb] rounded-md mt-6">
        <div className="flex justify-between items-center">
          <h2 className="font-semibold text-lg text-[#000000] pb-3 ">
            Recent Orders
          </h2>
